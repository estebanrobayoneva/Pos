...
class DetailsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create detail" do
    assert_difference('Detail.count') do
      post details_url, params: { detail: { cantidad_producto: @detail.cantidad_producto, precio: @detail.precio } }
    end
  ...
  test "should update detail" do
    patch detail_url(@detail), params: { detail: { cantidad_producto: @detail.cantidad_producto, precio: @detail.precio } }

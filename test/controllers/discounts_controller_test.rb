...
class DiscountsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create discount" do
    assert_difference('Discount.count') do
      post discounts_url, params: { discount: { descuento_porcentaje: @discount.descuento_porcentaje } }
    end
  ...
  test "should update discount" do
    patch discount_url(@discount), params: { discount: { descuento_porcentaje: @discount.descuento_porcentaje } }

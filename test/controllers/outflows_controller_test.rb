...
class OutflowsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create outflow" do
    assert_difference('Outflow.count') do
      post outflows_url, params: { outflow: { concepto: @outflow.concepto, entidad: @outflow.entidad, fecha: @outflow.fecha, nit: @outflow.nit, numero_factura: @outflow.numero_factura, valor: @outflow.valor } }
    end
  ...
  test "should update outflow" do
    patch outflow_url(@outflow), params: { outflow: { concepto: @outflow.concepto, entidad: @outflow.entidad, fecha: @outflow.fecha, nit: @outflow.nit, numero_factura: @outflow.numero_factura, valor: @outflow.valor } }
